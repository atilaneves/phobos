...
{name: 'std.container.rbtree.RedBlackTree.equalRange', kind: "templatedeclaration", path: './std/container/rbtree/red_black_tree.equal_range.html', attributes: []},
{name: 'std.container.rbtree.RedBlackTree.equalRange.equalRange', kind: "functiondeclaration", path: './std/container/rbtree/red_black_tree.equal_range.equal_range.html', attributes: ["auto"]},
...
{name: 'std.container.rbtree.RedBlackTree.lowerBound', kind: "functiondeclaration", path: './std/container/rbtree/red_black_tree.lower_bound.html', attributes: ["immutable"]},
...
{name: 'std.digest.digest.hasBlockSize', kind: "enummemberdeclaration", path: './std/digest/digest/has_block_size.html', attributes: []},
...
{name: 'std.digest.hmac.HMAC.start', kind: "functiondeclaration", path: './std/digest/hmac/hmac.start.html', attributes: []},
...
{name: 'std.experimental.testing.attrs', kind: "module", path: './std/experimental/testing/attrs.html', attributes: []},
{name: 'std.experimental.testing.attrs.hiddenTest', kind: "structdeclaration", path: './std/experimental/testing/attrs/hidden_test.html', attributes: []},
{name: 'std.experimental.testing.attrs.name', kind: "structdeclaration", path: './std/experimental/testing/attrs/name.html', attributes: []},
{name: 'std.experimental.testing.attrs.shouldFail', kind: "structdeclaration", path: './std/experimental/testing/attrs/should_fail.html', attributes: []},
{name: 'std.experimental.testing.attrs.singleThreaded', kind: "enumdeclaration", path: './std/experimental/testing/attrs/single_threaded.html', attributes: []},
{name: 'std.experimental.testing.gen_ut_main_mixin', kind: "module", path: './std/experimental/testing/gen_ut_main_mixin.html', attributes: []},
...
{name: 'std.experimental.testing.options', kind: "module", path: './std/experimental/testing/options.html', attributes: []},
{name: 'std.experimental.testing.options.getOptions', kind: "functiondeclaration", path: './std/experimental/testing/options/get_options.html', attributes: []},
{name: 'std.experimental.testing.options.Options', kind: "structdeclaration", path: './std/experimental/testing/options/options.html', attributes: []},
{name: 'std.experimental.testing.reflection', kind: "module", path: './std/experimental/testing/reflection.html', attributes: []},
{name: 'std.experimental.testing.reflection.allTestData', kind: "functiondeclaration", path: './std/experimental/testing/reflection/all_test_data.html', attributes: ["pure", "nothrow", "safe"]},
{name: 'std.experimental.testing.reflection.moduleTestData', kind: "functiondeclaration", path: './std/experimental/testing/reflection/module_test_data.html', attributes: ["pure", "nothrow", "safe"]},
{name: 'std.experimental.testing.reflection.TestData', kind: "structdeclaration", path: './std/experimental/testing/reflection/test_data.html', attributes: []},
{name: 'std.experimental.testing.reflection.TestFunction', kind: "aliasdeclaration", path: './std/experimental/testing/reflection/test_function.html', attributes: []},
{name: 'std.experimental.testing.runner', kind: "module", path: './std/experimental/testing/runner.html', attributes: []},
{name: 'std.experimental.testing.runner.runTests', kind: "functiondeclaration", path: './std/experimental/testing/runner/run_tests.html', attributes: []},
{name: 'std.experimental.testing.runner.runTestsMixin', kind: "templatedeclaration", path: './std/experimental/testing/runner/run_tests_mixin.html', attributes: []},
{name: 'std.experimental.testing.should', kind: "module", path: './std/experimental/testing/should.html', attributes: []},
{name: 'std.experimental.testing.should.shouldBeEmpty', kind: "functiondeclaration", path: './std/experimental/testing/should/should_be_empty.html', attributes: []},
{name: 'std.experimental.testing.should.shouldBeFalse', kind: "functiondeclaration", path: './std/experimental/testing/should/should_be_false.html', attributes: []},
{name: 'std.experimental.testing.should.shouldBeGreaterThan', kind: "functiondeclaration", path: './std/experimental/testing/should/should_be_greater_than.html', attributes: []},
{name: 'std.experimental.testing.should.shouldBeIn', kind: "functiondeclaration", path: './std/experimental/testing/should/should_be_in.html', attributes: []},
{name: 'std.experimental.testing.should.shouldBeNull', kind: "functiondeclaration", path: './std/experimental/testing/should/should_be_null.html', attributes: []},
{name: 'std.experimental.testing.should.shouldBeSameSetAs', kind: "functiondeclaration", path: './std/experimental/testing/should/should_be_same_set_as.html', attributes: []},
{name: 'std.experimental.testing.should.shouldBeSmallerThan', kind: "functiondeclaration", path: './std/experimental/testing/should/should_be_smaller_than.html', attributes: []},
{name: 'std.experimental.testing.should.shouldBeTrue', kind: "functiondeclaration", path: './std/experimental/testing/should/should_be_true.html', attributes: []},
{name: 'std.experimental.testing.should.shouldEqual', kind: "functiondeclaration", path: './std/experimental/testing/should/should_equal.html', attributes: []},
{name: 'std.experimental.testing.should.shouldNotBeEmpty', kind: "functiondeclaration", path: './std/experimental/testing/should/should_not_be_empty.html', attributes: []},
{name: 'std.experimental.testing.should.shouldNotBeIn', kind: "functiondeclaration", path: './std/experimental/testing/should/should_not_be_in.html', attributes: []},
{name: 'std.experimental.testing.should.shouldNotBeNull', kind: "functiondeclaration", path: './std/experimental/testing/should/should_not_be_null.html', attributes: []},
{name: 'std.experimental.testing.should.shouldNotBeSameSetAs', kind: "functiondeclaration", path: './std/experimental/testing/should/should_not_be_same_set_as.html', attributes: []},
{name: 'std.experimental.testing.should.shouldNotEqual', kind: "functiondeclaration", path: './std/experimental/testing/should/should_not_equal.html', attributes: []},
{name: 'std.experimental.testing.should.shouldNotThrow', kind: "functiondeclaration", path: './std/experimental/testing/should/should_not_throw.html', attributes: []},
{name: 'std.experimental.testing.should.shouldThrow', kind: "functiondeclaration", path: './std/experimental/testing/should/should_throw.html', attributes: []},
{name: 'std.experimental.testing.should.shouldThrowExactly', kind: "functiondeclaration", path: './std/experimental/testing/should/should_throw_exactly.html', attributes: []},
{name: 'std.experimental.testing.should.UnitTestException', kind: "classdeclaration", path: './std/experimental/testing/should/unit_test_exception.html', attributes: []},
...
{name: 'std.experimental.testing.testcase', kind: "module", path: './std/experimental/testing/testcase.html', attributes: []},
{name: 'std.experimental.testing.testcase.CompositeTestCase', kind: "classdeclaration", path: './std/experimental/testing/testcase/composite_test_case.html', attributes: []},
{name: 'std.experimental.testing.testcase.TestCase.collectOutput', kind: "functiondeclaration", path: './std/experimental/testing/testcase/test_case.collect_output.html', attributes: ["final"]},
{name: 'std.experimental.testing.testcase.TestCase.name', kind: "functiondeclaration", path: './std/experimental/testing/testcase/test_case.name.html', attributes: ["pure", "nothrow", "safe", "const"]},
{name: 'std.experimental.testing.testcase.TestCase.numTestsRun', kind: "functiondeclaration", path: './std/experimental/testing/testcase/test_case.num_tests_run.html', attributes: ["pure", "nothrow", "property", "safe", "const"]},
{name: 'std.experimental.testing.testcase.TestCase.opCall', kind: "functiondeclaration", path: './std/experimental/testing/testcase/test_case.op_call.html', attributes: []},
{name: 'std.experimental.testing.testcase.TestCase.test', kind: "functiondeclaration", path: './std/experimental/testing/testcase/test_case.test.html', attributes: ["abstract"]},
{name: 'std.experimental.testing.testcase.FunctionTestCase', kind: "classdeclaration", path: './std/experimental/testing/testcase/function_test_case.html', attributes: []},
{name: 'std.experimental.testing.testcase.ShouldFailTestCase', kind: "classdeclaration", path: './std/experimental/testing/testcase/should_fail_test_case.html', attributes: []},
{name: 'std.experimental.testing.testcase.TestCase', kind: "classdeclaration", path: './std/experimental/testing/testcase/test_case.html', attributes: []},
{name: 'std.experimental.testing.testsuite', kind: "module", path: './std/experimental/testing/testsuite.html', attributes: []},
{name: 'std.experimental.testing.testsuite.replaceModuleUnitTester', kind: "functiondeclaration", path: './std/experimental/testing/testsuite/replace_module_unit_tester.html', attributes: []},
{name: 'std.experimental.testing.testsuite.TestSuite', kind: "structdeclaration", path: './std/experimental/testing/testsuite/test_suite.html', attributes: []},
{name: 'std.experimental.testing.testsuite.TestSuite.run', kind: "functiondeclaration", path: './std/experimental/testing/testsuite/test_suite.run.html', attributes: []},
{name: 'std.experimental.testing.testsuite.TestSuite.this', kind: "functiondeclaration", path: './std/experimental/testing/testsuite/test_suite.this.html', attributes: ["ref"]},
{name: 'std.experimental.gen_ut_main', kind: "module", path: './std/experimental/gen_ut_main.html', attributes: []},
...
{name: 'std.net.curl.HTTP.defaultUserAgent', kind: "functiondeclaration", path: './std/net/curl/http.default_user_agent.html', attributes: ["property", "static"]},
...
{name: 'std.net.curl.HTTP.Method.patch', kind: "enummemberdeclaration", path: './std/net/curl/http.method.patch.html', attributes: []},
...
{name: 'std.concurrencybase', kind: "module", path: './std/concurrencybase.html', attributes: []},
...
{name: 'std.conv.toChars', kind: "functiondeclaration", path: './std/conv/to_chars.html', attributes: ["pure", "nothrow", "nogc", "safe", "auto"]},
...
{name: 'std.datetime.Clock.currStdTime', kind: "functiondeclaration", path: './std/datetime/clock.curr_std_time.html', attributes: ["property", "trusted"]},
...
{name: 'std.datetime.Clock.currTime', kind: "functiondeclaration", path: './std/datetime/clock.curr_time.html', attributes: ["safe"]},
...
{name: 'std.datetime.SysTime.fracSec', kind: "functiondeclaration", path: './std/datetime/sys_time.frac_sec.html', attributes: ["property", "safe", "deprecated"]},
{name: 'std.datetime.SysTime.fracSecs', kind: "functiondeclaration", path: './std/datetime/sys_time.frac_secs.html', attributes: ["nothrow", "property", "safe", "const"]},
...
{name: 'std.datetime.SysTime.fromUnixTime', kind: "functiondeclaration", path: './std/datetime/sys_time.from_unix_time.html', attributes: ["pure", "nothrow", "safe", "static"]},
...
{name: 'std.datetime.SysTime.toUnixTime', kind: "functiondeclaration", path: './std/datetime/sys_time.to_unix_time.html', attributes: ["const", "pure", "nothrow", "safe"]},
...
{name: 'std.typecons.RefCounted.refCountedPayload', kind: "functiondeclaration", path: './std/typecons/ref_counted.ref_counted_payload.html', attributes: []},
...
{name: 'etc.c.curl.CurlError.not_built_in', kind: "enummemberdeclaration", path: './etc/c/curl/curl_error.not_built_in.html', attributes: []},
...
{name: 'etc.c.curl.CurlError.unknown_option', kind: "enummemberdeclaration", path: './etc/c/curl/curl_error.unknown_option.html', attributes: []},
...
{name: 'object.TypeInfo.init', kind: "functiondeclaration", path: './object/type_info.init.html', attributes: ["pure", "nothrow", "nogc", "safe", "const", "abstract"]},
